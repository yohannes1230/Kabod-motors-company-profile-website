...
export const electricVehicles = [
  {
    ...
    manufacturerSpecs: {
      ...
      topSpeed: "200 km/h (electronically limited)",
      batteryType: "BYD High-Safety Blade Battery (LFP Chemistry)",
      batteryCapacity: "49.05 kWh + Range Extender Engine (PHEV/EREV platform)",
      comprehensiveRange: "Up to 1,000 km (CLTC combined)",
      pureElectricRange: "Up to 180 km (CLTC)",
      chargingTime: "DC Fast Charging 30% to 80% in ~18 minutes",
      suspension: "DiSus-P Intelligent Hydraulic Active Suspension (up to 150mm height adjustment)",
      dimensions: "5,319 mm (L) × 2,050 mm (W) × 1,930 mm (H)",
      wheelbase: "3,050 mm",
      wadingDepth: "1,000 mm (Standard) / 1,400 mm (Off-Road Master Edition)"
    }
  },
  {
    id: "byd-sealion-7",
    ...
    keyHighlights: [
      ...
      "Up to 550+ km WLTP Range on high-capacity Blade Battery",
      "DiSus-C Intelligent Damping Suspension System",
    ...
    manufacturerSpecs: {
      ...
      acceleration: "0-100 km/h in 4.5 seconds (AWD variant)",
      topSpeed: "215 km/h",
      batteryType: "BYD Blade Battery (Lithium Iron Phosphate - LFP)",
      batteryCapacity: "71.8 kWh / 82.5 kWh options",
      pureElectricRange: "Up to 550 - 610 km (CLTC/WLTP configured)",
      chargingTime: "High-voltage fast charge 10% to 80% in ~25 minutes",
      suspension: "Front Double Wishbone + Rear Five-Link with DiSus-C",
      dimensions: "4,830 mm (L) × 1,925 mm (W) × 1,620 mm (H)",
      wheelbase: "2,930 mm",
      luggageCapacity: "500 L expandable to 1,769 L"
    }
  },
  {
    id: "byd-atto-3",
    ...
    keyHighlights: [
      ...
      "Up to 420 km combined WLTP range on 60.48 kWh pack",
      "High-efficiency 8-in-1 electric powertrain assembly",
    ...
    manufacturerSpecs: {
      ...
      topSpeed: "160 km/h",
      batteryType: "BYD Ultra-Safe Blade Battery (LFP)",
      batteryCapacity: "49.92 kWh (Standard) / 60.48 kWh (Extended Range)",
      pureElectricRange: "420 km (WLTP) / 510 km (NEDC)",
      chargingTime: "DC Fast Charging (88 kW) 30% to 80% in ~29 minutes; 7 kW AC home",
      suspension: "Front MacPherson Strut + Rear Multi-Link Independent",
      dimensions: "4,455 mm (L) × 1,875 mm (W) × 1,615 mm (H)",
      wheelbase: "2,720 mm",
      safetyRating: "Euro NCAP 5-Star Safety Rated"
    }
  },
  {
    id: "byd-song-plus-ev",
    ...
    keyHighlights: [
      ...
      "Up to 520 km (CLTC) range with high-density Blade Battery",
      "Luxurious vegan leather interior with panoramic sunroof",
    ...
    manufacturerSpecs: {
      ...
      topSpeed: "175 km/h",
      batteryType: "BYD LFP Blade Battery Pack",
      batteryCapacity: "71.8 kWh / 87.0 kWh options",
      pureElectricRange: "520 km - 605 km (CLTC)",
      chargingTime: "140 kW DC Fast Charging 30% to 80% in ~28 minutes",
      suspension: "Front MacPherson Strut + Rear Multi-Link Independent",
      dimensions: "4,785 mm (L) × 1,890 mm (W) × 1,660 mm (H)",
      wheelbase: "2,765 mm",
      trunkVolume: "552 L expandable to 1,440 L"
    }
  },
  {
    id: "byd-seagull",
    ...
    keyHighlights: [
      ...
      "Up to 305 km - 405 km range on dependable Blade Battery",
      "Modern cyber-punk interior with 10.1-inch rotating display",
    ...
    manufacturerSpecs: {
      ...
      totalTorque: "135 Nm",
      acceleration: "0-50 km/h in 4.9 seconds / 0-100 km/h in 13.0 seconds",
      topSpeed: "130 km/h",
      batteryType: "BYD Blade Battery (LFP Chemistry)",
      batteryCapacity: "30.08 kWh (Standard) / 38.88 kWh (Extended)",
      pureElectricRange: "305 km (CLTC 30.08 kWh) / 405 km (CLTC 38.88 kWh)",
      chargingTime: "DC Fast Charging 30% to 80% in 30 minutes; AC 3.3/6.6 kW",
      suspension: "Front MacPherson Strut + Rear Torsion Beam",
      dimensions: "3,780 mm (L) × 1,715 mm (W) × 1,540 mm (H)",
      wheelbase: "2,500 mm",
      curbWeight: "1,160 - 1,240 kg"
    }
  },
  {
    id: "byd-atto-2",
    ...
    keyHighlights: [
      ...
      "Up to 401 km (CLTC) range on 45.12 kWh Blade Battery",
      "High ground clearance with protective all-around body cladding",
    ...
    manufacturerSpecs: {
      ...
      acceleration: "0-100 km/h in 7.9 seconds (130 kW version)",
      topSpeed: "160 km/h",
      batteryType: "BYD Ultra-Safe Blade Battery (LFP)",
      batteryCapacity: "32 kWh / 45.12 kWh",
      pureElectricRange: "301 km / 401 km (CLTC)",
      chargingTime: "DC Fast Charge 30% to 80% in ~30 minutes",
      suspension: "Front MacPherson Strut + Rear Torsion Beam",
      dimensions: "4,310 mm (L) × 1,830 mm (W) × 1,675 mm (H)",
      wheelbase: "2,620 mm",
      minimumGroundClearance: "175 mm"
    }
  },
  {
    id: "toyota-bz4x",
    ...
    manufacturerSpecs: {
      ...
      acceleration: "0-100 km/h in 6.9 seconds (AWD) / 7.5 seconds (FWD)",
      topSpeed: "160 km/h",
      batteryType: "Lithium-Ion Battery Pack with Water Cooling",
      batteryCapacity: "71.4 kWh (FWD) / 72.8 kWh (AWD)",
      pureElectricRange: "Up to 450 - 516 km (WLTP variant dependent)",
      chargingTime: "150 kW DC Fast Charging 10% to 80% in ~30 minutes; 11 kW AC",
      suspension: "Front MacPherson Strut + Rear Double Wishbone Independent",
