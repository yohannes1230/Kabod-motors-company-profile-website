/**
 * GALLERY DATASET (Tier B & Visual Assets)
 * Structured catalog of all 40 local repository assets categorized with high-resolution paths and metadata.
 */
...
export const galleryItems = [
  ...
  // 2. Heavy Machinery & Construction
  {
    id: "g-mach-01",
    category: "machinery",
    title: "Sinotruk Howo TX Heavy Dump Truck 6x4",
    caption: "High-tonnage 6x4 heavy construction hauler with reinforced manganese steel tipper body.",
    src: "/images/Howo-Tx-Dump-Truck-6x4-1.webp",
  ...
  },
  {
    ...
    src: "/images/images (20).jfif",
    dimensions: "515x388",
    tag: "Commercial Fleet"
  },

  // 3. Premium Lubricants (Koryo Oil Korea)
  {
    id: "g-lub-01",
    category: "lubricants",
  ...
  },
  {
    ...
    src: "/images/images (28).jfif",
    dimensions: "225x225",
    tag: "Refinery Art"
  },

  // 4. Energy Storage (Maxtorm Korea / Sebang)
  {
    id: "g-bat-01",
    category: "energy",
  ...
  },
  {
    ...
    src: "/images/images (36).jfif",
    dimensions: "494x619",
    tag: "Endurance Power"
  },

  // 5. Technology & Digital Cockpits
  {
    id: "g-tech-01",
    category: "technology",
